...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'helloworld.wast';
  var wasmBinaryFile = 'helloworld.wasm';
  var asmjsCodeFile = 'helloworld.temp.asm.js';
...
var real__helloworld = asm["_helloworld"]; asm["_helloworld"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__helloworld.apply(null, arguments);
};
...
var _helloworld = Module["_helloworld"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_helloworld"].apply(null, arguments) };
